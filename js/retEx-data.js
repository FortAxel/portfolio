const retexData = {
    'towa': {
        ...
        image: './img/illustration_towa.webp',
        requirements: [
    ...
    'robocup': {
        ...
        image: './img/illustration_robocup.webp',
        requirements: [
    ...
    'reseau': {
        ...
        toolLogos: ['./img/logo_bash.webp']
    },
    'pixelwar': {
        linkTitle: 'Client Pixel Waj (js)',
        title: 'Client Pixel War',
        image: './img/illustration_pixelWar.webp',
        requirements: [
        ...
        toolLogos: ['./img/logo_web.webp']
    },
    'unideck': {
        linkTitle: 'Jeu de cartes 1 vs 1 (C#)',
        title: 'Jeu de cartes 1 vs 1',
        image: './img/illustration_uniDeck.webp',
        requirements: [
